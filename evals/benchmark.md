...
| public-writing | SF-03, SF-05, SF-08, SF-10, SF-12, SF-13, SF-16, SF-20, SF-28, SF-32, SF-33, SF-35, SNF-12, SNF-24, SNF-25, SNF-27 | SF-34, SF-39, SF-40, SNF-26, SNF-29, SNF-30 | SF-14 | - |
| code-context | - | - | - | SNF-22 |

`Long-form / in-place` 额外覆盖：SF-39、SF-40、SNF-29、SNF-30。它们验证的不是“更轻一档”，而是 `scope = in-place` 时不删整句、不并句、不重排段落。
